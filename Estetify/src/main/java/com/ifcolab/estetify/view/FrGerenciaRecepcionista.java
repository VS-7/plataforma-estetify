...
public class FrGerenciaRecepcionista extends javax.swing.JDialog {

    private RecepcionistaController controller;
    private int idRecepcionistaEditando;
    
    public FrGerenciaRecepcionista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        grdRecepcionistas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                grdRecepcionistasMouseClicked(evt);
            }
        });
    ...
    private void preencherFormulario(Recepcionista recepcionista) {
        ...
        edtSexo.setText(recepcionista.getSexo());
    ...
    private void initComponents() {
        ...
        fEdtDataContratacao = new com.ifcolab.estetify.components.CustomFormattedTextField();
        ...
        lblDataContratacao.setText("Data de Contratação");
        getContentPane().add(lblDataContratacao);
        lblDataContratacao.setBounds(1030, 210, 140, 17);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Primeiro selecione um registro na tabela.");
            ...
            int response = JOptionPane.showConfirmDialog(null,
                "Deseja excluir a Recepcionista \n("
    ...
    private void grdRecepcionistasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grdRecepcionistasMouseClicked
        if (evt.getClickCount() == 2) {
            btnEditarActionPerformed(null);
        }
    }//GEN-LAST:event_grdRecepcionistasMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrGerenciaRecepcionista dialog = new FrGerenciaRecepcionista(new javax.swing.JFrame(), true);
    ...
    private com.ifcolab.estetify.components.CustomFormattedTextField fEdtDataContratacao;
