...
public class FrAgendaConsulta extends javax.swing.JFrame {

    /**
     * Creates new form FrLogin
     */
    public FrAgendaConsulta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        customTable2 = new com.ifcolab.estetify.components.CustomTable();
        ...
        primaryCustomButton1.setBounds(370, 100, 150, 30);
        ...
        btnSair.setBounds(10, 910, 210, 30);

        lblTitulo1.setFont(new java.awt.Font("Fira Sans Medium", 0, 18)); // NOI18N
        lblTitulo1.setForeground(new java.awt.Color(0, 0, 0));
        lblTitulo1.setText("Agendamentos");
        getContentPane().add(lblTitulo1);
        lblTitulo1.setBounds(360, 380, 250, 20);
        ...
        jScrollPane2.setBounds(350, 410, 1000, 520);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrAgendaConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrAgendaConsulta().setVisible(true);
            }
        });
    }
    ...
    private com.ifcolab.estetify.components.CustomTable customTable2;
