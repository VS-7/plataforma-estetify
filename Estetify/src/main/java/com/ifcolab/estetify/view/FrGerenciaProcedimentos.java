 ...
 * @author vitorsrgio
 */
public class FrGerenciaProcedimentos extends javax.swing.JFrame {

    /**
     * Creates new form FrLogin
     */
    public FrGerenciaProcedimentos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtCpf1 = new com.ifcolab.estetify.components.CustomTextField();
        ...
        lblSexo.setText("Valor");
        getContentPane().add(lblSexo);
        lblSexo.setBounds(690, 170, 160, 17);

        txtSexo.setText("Valor");
        ...
        txtCpf1.setText("Contraindicações");
        ...
        txtCpf1.setBounds(360, 270, 270, 38);

        lblCpf1.setForeground(new java.awt.Color(51, 51, 51));
        lblCpf1.setText("Contraindicações");
        getContentPane().add(lblCpf1);
        lblCpf1.setBounds(370, 250, 110, 17);

        lblCpf.setForeground(new java.awt.Color(51, 51, 51));
        lblCpf.setText("Requisitos");
        getContentPane().add(lblCpf);
        lblCpf.setBounds(1090, 170, 110, 17);

        lblCrm.setForeground(new java.awt.Color(51, 51, 51));
        lblCrm.setText("Data/Hora");
        ...
        lblNome.setBounds(370, 170, 190, 17);
        ...
        lblTitulo.setText("Gerenciar procedimentos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrGerenciaProcedimentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrGerenciaProcedimentos().setVisible(true);
            }
        });
    }
    ...
    private com.ifcolab.estetify.components.CustomTextField txtCpf1;
